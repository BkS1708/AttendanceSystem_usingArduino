//This code works perfectly for Addition of FIngerprints and Checking them(Checking ma keep the finger ready and then press 2)
...
void checkFingerprint() {
  Serial.println("Place your finger to check...");
